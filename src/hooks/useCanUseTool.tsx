          ...
          case "ask":
            {
              ...
              if ( && result.pendingClassifierCheck && tool.name === BASH_TOOL_NAME && !appState.toolPermissionContext.awaitAutomatedChecksBeforeDialog) {
              ...
              handleInteractivePermission({
                ...
                bridgeCallbacks:  ? appState.replBridgePermissionCallbacks : undefined,
                channelCallbacks:  ||  ? appState.channelPermissionCallbacks : undefined
              }, resolve);
              return;
            }
        }
