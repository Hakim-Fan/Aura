...
const teamMemCollapsed =  ? require('./teamMemCollapsed.js') as typeof import('./teamMemCollapsed.js') : null;
...
export function CollapsedReadSearchContent({
  ...
  const hasTeamMemoryOps =  ? teamMemCollapsed!.checkHasTeamMemOps(message) : false;
