...
export function Config({
  ...
  const showAutoInDefaultModePicker =  ? hasAutoModeOptInAnySource() || getAutoModeEnabledState() === 'enabled' : false;
  ...
  const showDefaultViewPicker =  ||  ? (require('../../tools/BriefTool/BriefTool.js') as typeof import('../../tools/BriefTool/BriefTool.js')).isBriefEntitled() : false;
  ...
  ...("external" === 'ant' ? [{
    ...
    options: (() => {
      ...
      const allModes: readonly PermissionMode[] =  ? PERMISSION_MODES : EXTERNAL_PERMISSION_MODES;
  ...
  autoUpdaterDisabledReason ? {
    ...
    id: 'notifChannel',
    label:  ||  ? 'Local notifications' : 'Notifications',
  ...
  const revertChanges = useCallback(() => {
    ...
    // onChange above, so no  guard needed here (that path only
