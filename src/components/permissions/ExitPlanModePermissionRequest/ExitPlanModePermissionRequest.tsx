...
const autoModeStateModule =  ? require('../../../utils/permissions/autoModeState.js') as typeof import('../../../utils/permissions/autoModeState.js') : null;
...
export function ExitPlanModePermissionRequest({
  ...
  //  must sit directly in an if/ternary (bun:bundle DCE constraint).
  const showUltraplan =  ? !ultraplanSessionUrl && !ultraplanLaunching : false;
  ...
  async function handleResponse(value: ResponseValue): Promise<void> {
    ...
    const isResumeAutoOption =  ? value === 'yes-resume-auto-mode' : false;
