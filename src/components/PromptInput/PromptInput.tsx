...
function PromptInput({
  ...
  const tokenBudgetTriggers = useMemo(() =>  ? findTokenBudgetPositions(displayedValue) : [], [displayedValue]);
  ...
  // the handler body is -gated so the setState calls and component
  // references get tree-shaken in external builds.
  const quickSearchActive =  ? !isModalOverlayActive : false;
  ...
  useKeybinding('history:search', () => {
    ...
    context: 'Global',
    isActive:  ? !isModalOverlayActive : false
  });
