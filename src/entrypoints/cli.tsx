...
// module-level consts at import time — init() runs too late.  gate
// DCEs this entire block from external builds.
// eslint-disable-next-line custom-rules/no-top-level-side-effects, custom-rules/no-process-env-top-level
if ( && process.env.CLAUDE_CODE_ABLATION_BASELINE) {
...
async function main(): Promise<void> {
  ...
  //  must stay inline for build-time dead code elimination;
  ...
  // heartbeat).  must stay inline for build-time dead code elimination.
