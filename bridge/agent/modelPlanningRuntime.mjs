...
export function buildModelPlanningSystemPrompt(settings = {}) {
  ...
  return [
    ...
    '{"type":"plan","goal":"...","risk":"low|medium|high","requiresApproval":false,"steps":[{"id":"1","description":"short step title","kind":"context|execute|verify|respond","acceptance":"what proves this step is done","requiredEvidence":["skill_read","file_parsed"]}],"successCriteria":["..."],"notes":"..."}',
    ...
    '',
    'Keep every plan step description as a UI title within 20 Chinese characters or 8 English words. Describe WHAT should happen, not implementation code, background, risks, or acceptance details.',
